...
var poll = function () {
  ...
  script.src = 'http://127.0.0.1:27493/_panels/ping?callback=init&random=' + Math.random()
...
var startPanel = function () {
  ...
  var url = 'http://127.0.0.1:27493/panel/?platform=photoshop&version=' + appConfig.getVersionString()
...
e.extensionId = 'com.madebysource.pnghat'
cs.dispatchEvent(e)
